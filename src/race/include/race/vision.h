...
namespace VISION
{
    ...
    void turn_sign_image(Mat original_image, Mat image, double epsilon, int minContour, int maxContour, double lowerBondArea);
    ...
    void taking_photo(int imageName); // 自動拍攝
