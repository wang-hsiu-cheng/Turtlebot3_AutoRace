...
void VISION::road_line_image()
{
    // continue detecting where the road line is.
    // have ability to identify road according to only right/left side of road line.
    // update left line begin point, left line vector, right line begin point and right line vector.
}
