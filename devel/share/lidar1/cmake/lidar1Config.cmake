...
if("TRUE" STREQUAL "TRUE")
  set(lidar1_SOURCE_PREFIX /home/miffy1233/racing/Turtlebot3_AutoRace/src/lidar1)
  set(lidar1_DEVEL_PREFIX /home/miffy1233/racing/Turtlebot3_AutoRace/devel)
  set(lidar1_INSTALL_PREFIX "")
  set(lidar1_PREFIX ${lidar1_DEVEL_PREFIX})
else()
  set(lidar1_SOURCE_PREFIX "")
  set(lidar1_DEVEL_PREFIX "")
  set(lidar1_INSTALL_PREFIX /home/miffy1233/racing/Turtlebot3_AutoRace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/miffy1233/racing/Turtlebot3_AutoRace/src/lidar1/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lidar1_NUM_DUMMY_TARGETS)
      set(lidar1_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lidar1::wrapped-linker-option${lidar1_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lidar1_NUM_DUMMY_TARGETS "${lidar1_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lidar1::wrapped-linker-option${lidar1_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lidar1_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lidar1_EXPORTED_TARGETS ${${lidar1_dep}_EXPORTED_TARGETS})
endforeach()
