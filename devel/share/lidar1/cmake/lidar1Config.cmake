...
if("TRUE" STREQUAL "TRUE")
  set(lidar1_SOURCE_PREFIX /home/twang/Turtlebot3_AutoRace/src/lidar1)
  set(lidar1_DEVEL_PREFIX /home/twang/Turtlebot3_AutoRace/devel)
  set(lidar1_INSTALL_PREFIX "")
  set(lidar1_PREFIX ${lidar1_DEVEL_PREFIX})
else()
  set(lidar1_SOURCE_PREFIX "")
  set(lidar1_DEVEL_PREFIX "")
  set(lidar1_INSTALL_PREFIX /home/twang/Turtlebot3_AutoRace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/twang/Turtlebot3_AutoRace/src/lidar1/${idir}'.  ${_report}")
    endif()
