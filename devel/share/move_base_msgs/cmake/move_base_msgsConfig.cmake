...
if("TRUE" STREQUAL "TRUE")
  set(move_base_msgs_SOURCE_PREFIX /home/twang/Turtlebot3_AutoRace/src/navigation_msgs/move_base_msgs)
...
if(NOT "/home/twang/Turtlebot3_AutoRace/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'move_base_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/twang/Turtlebot3_AutoRace/src/navigation_msgs/move_base_msgs/${idir}'.  ${_report}")
    endif()
